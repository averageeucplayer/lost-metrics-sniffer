...
#[repr(C)]
#[derive(Debug, Default, Serialize, Deserialize, StableAbi, Clone)]
...
#[repr(C)]
#[derive(Debug, Serialize, Deserialize, Default, StableAbi, Clone)]
...
#[repr(C)]
#[derive(Debug, Serialize, Deserialize, Default, StableAbi, Clone, Copy)]
